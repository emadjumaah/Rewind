...
function getUrgencyColor(deadline: Date): string {
  ...
  if (hoursLeft < 24) return 'border-2 border-red-500/60 shadow-md shadow-red-500/20 bg-gradient-to-br from-red-500/15 to-red-900/5'
  if (hoursLeft < 72) return 'border-2 border-amber-500/50 shadow-md shadow-amber-500/15 bg-gradient-to-br from-amber-500/10 to-amber-900/5'
  if (hoursLeft < 168) return 'border border-blue-500/40 shadow-sm shadow-blue-500/10 bg-gradient-to-br from-blue-500/5 to-blue-900/5'
      ...
      <div className="flex items-start gap-3">
        <div className="relative">
          <svg className="w-20 h-20" viewBox="0 0 100 100">
            <defs>
              <radialGradient id={`urgencyGradient-${deadline.id}`} cx="50%" cy="50%" r="50%">
        ...
        <div className="flex-1">
          <h3 className="text-base font-semibold mb-1 tracking-tight">{deadline.title}</h3>
