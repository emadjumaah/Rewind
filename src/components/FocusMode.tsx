...
export default function FocusMode() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        {/* Ambient background with slow-moving gradients */}
        <div className="absolute inset-0">
          <motion.div
            className="absolute inset-0 bg-gradient-to-br from-cyan-900/10 via-transparent to-purple-900/10"
            animate={{
          ...
          />
          <motion.div
            className="absolute inset-0 bg-gradient-to-tl from-amber-900/5 via-transparent to-cyan-900/5"
            animate={{
        ...
        <div className="text-center relative z-10">
          ...
          <motion.div
            ...
            className="relative"
          >
            {/* Giant reverse countdown with progress ring */}
